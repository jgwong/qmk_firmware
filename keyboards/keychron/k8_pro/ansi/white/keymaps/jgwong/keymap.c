...
[JCAPS] = LAYOUT_tkl_ansi(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_INS,   KC_DEL,   _______,  K_BROW_P, K_BROW_N, KC_BTN3,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  TO(MOUSE),_______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, _______,  _______,            KC_BTN1,
    _______,            _______,  _______,  _______,  _______,  _______,  KC_PGUP,  KC_PGDN,  KC_HOME,  KC_END,   _______,            _______,            _______,
    _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______,  _______,  _______
),
...
[MOUSE] = LAYOUT_tkl_ansi(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_BTN3,  _______,  _______,  _______,
